...
**** connecting from emacs
     ...
     #+begin_example
       ...
       >>> info.all_field_keys()
       frozenset(['rating', u'#issue', 'title_sort', 'application_id', 'pubdate', 'series', 'author_sort_map', u'#project', u'#volume', 'publication_type', 'size', 'author_link_map', 'rights', 'uuid', 'title', u'#keywords', 'comments', u'#progress', 'languages', 'cover_data', 'toc', 'thumbnail', u'#pages', 'db_id', 'user_metadata', 'tags', 'timestamp', 'last_modified', 'mime', u'#priority', 'authors', u'#abstract', 'publisher', 'series_index', 'lpath', 'user_categories', 'spine', 'author_sort', 'cover', 'book_producer', 'manifest', 'formats', 'guide', 'device_collections', 'identifiers'])
